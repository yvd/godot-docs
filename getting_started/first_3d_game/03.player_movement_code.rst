...
Select the newly instanciated Player node, in the Inspector tab under Node 
section, load the previously created player script i.e. ``Player.gd.``.
...
.. |image12| image:: img/03.player_movement_code/14.attach_player_script.webp
